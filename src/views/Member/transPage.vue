                            ...
                            <table class="table table-striped table-bordered mt-4">
                                ...
                                <tbody>
                                    <tr v-for="(member, id) in members" :key="id">
                                        ...
                                        <td> <p v-if="member.STATUS_MEMBER==1" style="color: forestgreen;">Aktif</p> 
                                             <p v-else style="color: red;">Belum Aktif</p>
                                        </td>
                                        <td class="text-center">
                                            <router-link :to="{name:'member.card', params: { id: member.NO_MEMBER }}" v-if="member.STATUS_MEMBER==0" class="btn btn-sm btn-outline-success">AKTIVASI</router-link><br>
                                            ...
                                            <router-link :to="{name:'member.edit', params: { id: member.NO_MEMBER }}" class="btn btn-sm btn-outline-primary">DEPOSIT KELAS</router-link>
