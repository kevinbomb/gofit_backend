                ...
                <div class="col-md-12">
                    <div class="card border-0 rounded shadow">
                        <div class="card-body">
                            ...
                            <h2 style="text-decoration: underline;" class="card-title mb-0 text-dark">LAPORAN AKTIVITAS GYM Bulanan</h2>
                            <h4 style="text-decoration: underline;" class="card-title mb-0 text-dark">Bulan: September</h4>
                           ...
                           <table class="table table-striped table-bordered mt-4">
                                ...
                                <tbody>
                                    <tr v-for="(laporan, id) in laporans" :key="id">
                                        <td>{{ laporan.TANGGAL_PRESENSIG }}</td>
...
export default {
    setup() {
        ...
        function getData() {
            ...
            axios.get('http://localhost:8000/api/laporanGymSep', {
                headers: {
