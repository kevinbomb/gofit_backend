                                ...
                                <tbody>
                                    <tr v-for="(presensi, id) in presensiks" :key="id">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <router-link :to="{name:'presensiK.card', params: { id: presensi.NO_PRESENSIK }}" class="btn btn-sm btn-outline-success">SHOW</router-link>
                                        </td>
                                    </tr>
...
export default {
    setup() {
        ...
        function getData(){
            ...
            axios.get('http://localhost:8000/api/presensiKelas1', {
                headers: {
